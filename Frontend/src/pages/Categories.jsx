        ...
        <div className="bg-gradient-to-br from-purple-900 via-indigo-800 to-purple-900 text-white py-20">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="text-center">
              ...
              >
                Discover amazing content across various topics, curated just for you.
              </motion.p>
            </div>
          </div>
        </div>
              ...
              >
                ...
                <div className="relative p-8 h-full min-h-[400px] flex flex-col">
                  ...
                  <div className="mt-auto">
                    ...
                    <button className="inline-flex items-center space-x-2 bg-white/20 hover:bg-white/30 backdrop-blur-sm text-white px-6 py-3 rounded-full transition-all duration-300 transform group-hover:translate-x-2">
