...
const MyBlogs = () => {
    ...
    const fetchBlogs = async () => {
      ...
      try {
        ...
        const response = await axios.get(
          `https://quickquill-backend.vercel.app/server/user/getuserblogs/${currentUser.userId}`
        );
  ...
  const handleConfirmDelete = async () => {
    ...
    try {
      ...
      await axios.delete(`https://quickquill-backend.vercel.app/server/blog/delete/${selectedBlog._id}`);
